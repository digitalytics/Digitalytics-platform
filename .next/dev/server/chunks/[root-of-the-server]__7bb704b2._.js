...
const stripe = globalForStripe.stripe ?? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](process.env.STRIPE_SECRET_KEY, {
    apiVersion: '2024-11-20.acacia'
});
if ("TURBOPACK compile-time truthy", 1) globalForStripe.stripe = stripe;
}),
"[project]/app/api/billing/invoices/[invoiceId]/pay/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const APP_URL = ("TURBOPACK compile-time value", "https://b560-2400-adc7-3103-2f00-5c5f-176a-3b76-a997.ngrok-free.app") ?? process.env.NEXTAUTH_URL ?? 'http://localhost:3000';
async function POST(_req, { params }) {
    try {
        ...
        const invoice = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoice.findFirst({
            where: {
                id: invoiceId,
        ...
        if (!stripeCustomerId) {
            const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripe"].customers.create({
        ...
        // ── Update invoice ─────────────────────────────────────────────────────────
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoice.update({
            where: {
                id: invoice.id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7bb704b2._.js.map