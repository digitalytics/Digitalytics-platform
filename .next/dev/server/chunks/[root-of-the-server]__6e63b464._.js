    ...
    callbacks: {
        async signIn ({ user, account }) {
            if (account?.provider === 'google') {
                const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                    where: {
                        email: user.email
                    }
                });
        ...
        async jwt ({ token, user }) {
            ...
            if (token.id) {
                const dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                    where: {
                        id: token.id
                    },
                    select: {
...
const nextAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(authConfig);
...
const handler = (req)=>{
    ...
    if (publicRoutes.some((r)=>pathname.startsWith(r))) {
        if (session?.user && session.user.status === 'ACTIVE') {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(dest, req.url));
        }
    ...
    if (userStatus === 'PENDING') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/pending', req.url));
    }
    // Inactive users
    if (userStatus === 'INACTIVE') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/login?error=INACTIVE', req.url));
    }
    // Admin-only routes
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["auth"])(handler);
const config = {
    matcher: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e63b464._.js.map