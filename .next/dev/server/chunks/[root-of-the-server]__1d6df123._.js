...
"[project]/app/api/admin/billing/invoices/[invoiceId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        ...
        // When marking PAID: set setupFeePaid = true on every UserAgent
        // that has a SETUP_FEE line item in this invoice
        if (status === 'PAID') {
            const setupLineItems = await tx.invoiceLineItem.findMany({
                where: {
                    invoiceId,
                    type: 'SETUP_FEE'
                },
            ...
            if (setupLineItems.length > 0) {
                const agentRetellIds = setupLineItems.map((li)=>li.agentId).filter(Boolean);
                // Find UserAgent rows matching this user + agents
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d6df123._.js.map